...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Customer Usage Dashboard</title>
...
if(null != request.getAttribute("errorMsg")){
  ...
  <section class="container">
    <div class="login">
    <br>
      <h1 align="center" style="text-shadow: 2px; font: bold;">Cutomer Usage Dashboard</h1>
					...
					<form method="post" action="LoginController" name="loginform" id="loginform" onsubmit="return validateForm('loginform')" >
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="customerId" id="customerId" type="text" placeholder="Customer Id"/>
							</div>
